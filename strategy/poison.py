...
class 中毒(StrategyTree):
    def __init__(self):
        ...
        self.add(newStra = Strategy(name = "毒素污染", level = 1, location = "auto", trigger = "auto")) #　TODO
        self.add(newStra = Strategy(name = "强效中毒", level = 1, location = "auto", trigger = "auto"))
        self.add(newStra = Strategy(name = "毒素扩散", level = 1, location = "auto", trigger = "auto")) # TODO
...
class 史莱姆(StrategyTree):
    def __init__(self):
        ...
        self.add(newStra = Strategy(name = "结队史莱姆", level = 3, location = "auto", trigger = ["召唤史莱姆"], entity = ["史莱姆"]))
